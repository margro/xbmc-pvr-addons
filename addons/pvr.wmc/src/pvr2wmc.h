...
public:
	...
	//virtual void SendAddonVersion(std::string);

	//virtual bool GetBool(TCHAR* request);
	//virtual std::string GetString(TCHAR* request);
	//virtual int GetInt(TCHAR* request);
...
private:
	...
	//bool GetBool(CStdString request);
	//int GetInt(CStdString request);
	//std::vector<CStdString> GetVector(CStdString request);
